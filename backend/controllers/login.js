...
function getUser(username, password) {
    ...
    return jsonUsers.users.findIndex(user => user.username === username && user.password === password) !== -1
}
...
const login = async(req = request, res = response) => {
    ...
    if (username == useradmin && password == passadmin) {
        console.log("Se esta logueando el usuario administrador que esta en el env")
